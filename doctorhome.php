            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-2 d-none d-lg-block appoint">
                        <a href="appointments.php"><button class="btn btn-success">Appointments</button></a>
                    </div>
                </div>
...
<div class="appoint" style="position: absolute;top: 1200px; left:1000px;">
  <a href="appointments.php">
   <button class="btn btn-success" style="width:300px;height: 60px;font-size: 2rem;">Appointments</button></a>
  </div><br><br><br><br>
...
<div class="review">
  ...
  <div class="meditext">
    ...
    <p class="medp7">PeopleCare is an Online Doctor Consultation Platform where one can have a live chat with a doctor on Web/App. This virtual doctor app<br> provides easy access to a GP online via audio, video or chat, as per the customer’s convenience.</p>
